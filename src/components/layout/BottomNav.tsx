...
const HomeIcon = ({ active }: { active: boolean }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={active ? '#df6530' : '#666'} strokeWidth={active ? 2.2 : 1.8} strokeLinecap="round" strokeLinejoin="round">
...
export function BottomNav() {
  ...
  return (
    <nav style={{
      ...
      width: '100%', maxWidth: '480px', background: '#1a1a1a',
