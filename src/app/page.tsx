  ...
  return (
    <div style={{
      ...
      >
        ...
        <span style={{ fontWeight: 'var(--font-weight-semibold)' as unknown as number, color: 'var(--color-text-primary)', fontSize: 'var(--font-size-heading)' }}>{kurdishStrings.signInWithGoogle}</span>
      </div>
