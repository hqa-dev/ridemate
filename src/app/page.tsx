...
export const metadata: Metadata = {
  ...
  description: 'ڕێ ئەپێکە بۆ هاوسەفەری لە نێوان شارەکانی کوردستان. شۆفێر ڕێ پۆست دەکات، سەرنشین داوا دەکات، پێکەوە دەچن.',
}
      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Step number="١" title="شۆفێر ڕێ پۆست دەکات" desc="شوێن، بەروار، کات، و ژمارەی جێ دیاری دەکات" />
