      ...
      <div style={{ padding: '0 1.25rem 3rem' }}>
        <div style={{ background: '#fae8d8', border: '1px solid #f5cdb0', borderRadius: '1rem', padding: '1rem' }}>
          <p style={{ color: '#92400e', fontSize: '0.85rem', lineHeight: 1.8 }}>
            هاوڕێیەکی نزیکی خۆم، حەمە، هەر کە ڕێی ئەکەوتە دەرەوەی هەولێر، پۆستیێکی ئەکرد و ئەیوت ئەچم بۆ هەولێر و ٣ شوێنی بەتاڵم هەیە، ئەوەی دێ بەخێر بێ. ئەوە بوو هۆی ئەم ئاپە.
          </p>
        </div>
      </div>
    </main>  )
