...
export default function HomePage() {
  ...
  return (
    <div style={{ direction: 'rtl', height: '100vh', background: 'var(--color-bg-canvas)', maxWidth: 'var(--size-app-maxWidth)', margin: '0 auto', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {/* Sketch car on road */}
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '6px 0 0', marginBottom: 38, flexShrink: 0 }}>
        <SketchCar size={88} color="var(--color-brand-primary)" />
