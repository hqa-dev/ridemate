...
export default function RideDetailPage() {
  ...
  return (
    <div style={pageWrap}>
      ...
      {/* ===== OUTER CARD — the one Design D card ===== */}
      <div style={{
        background: '#fff',
        ...
        <div style={{ padding: '1rem 1.25rem 1.25rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginBottom: '0.85rem' }}>
            <span style={{ background: '#fef3eb', color: '#df6530', padding: '0.4rem 1rem', borderRadius: '999px', fontSize: '0.8rem', fontWeight: 700 }}>☕ قاوەیەک</span>
            <span style={{ background: '#eef6ff', color: '#2563eb', padding: '0.4rem 1rem', borderRadius: '999px', fontSize: '0.8rem', fontWeight: 600 }}>💺 ٣ شوێن</span>
            <span style={{ background: '#f3f3f3', color: '#777', padding: '0.4rem 1rem', borderRadius: '999px', fontSize: '0.8rem' }}>🚭 بێ جگەرە</span>
          </div>
