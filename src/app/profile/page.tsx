...
const Icons = {
  ...
  personFallback: (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke={T.iconDim} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" />
    </svg>
  ),
  trash: (
      ...
      <div style={{ padding: '0 0 120px' }}>
        ...
        <div style={{ background: T.card, margin: '0 12px', borderRadius: 10, padding: '0 14px', border: `2px solid ${T.text}`, boxShadow: `3px 3px 0 ${T.text}` }}>
            ...
            {editingName && (
              <div style={{ padding: '12px 0 14px', borderBottom: `1.5px dashed ${T.textDim}` }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
                  ...
                  <button onClick={() => setEditingName(false)} style={{ background: 'none', border: 'none', color: T.iconDim, fontSize: 11, cursor: 'pointer', padding: '10px 16px', fontFamily: "'Noto Sans Arabic', sans-serif" }}>پاشگەز</button>
                </div>
              </div>
            )}
          </div>
            ...
            {editingPhone && (
              <div style={{ padding: '12px 0 14px', borderBottom: `1.5px dashed ${T.textDim}` }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
                  ...
                  <button onClick={() => setEditingPhone(false)} style={{ background: 'none', border: 'none', color: T.iconDim, fontSize: 11, cursor: 'pointer', padding: '10px 16px', fontFamily: "'Noto Sans Arabic', sans-serif" }}>پاشگەز</button>
                </div>
              </div>
            )}
          </div>
          ...
          <div>
            <div onClick={toggleEmail} style={{ display: 'flex', alignItems: 'center', padding: '13px 0', cursor: 'pointer' }}>
              ...
              <span style={{ flex: 1, fontSize: 14, color: T.textMid }}>ئیمەیل</span>
            ...
            {editingEmail && (
              <div style={{ padding: '12px 0 14px' }}>
                ...
                <div style={{ fontSize: 10, color: T.iconDim, marginTop: 6, paddingRight: 2 }}>لینکی پشتڕاستکردن دەنێردرێت بۆ ئیمەیلە نوێیەکە</div>
                <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
                  ...
                  <button onClick={() => setEditingEmail(false)} style={{ background: 'none', border: 'none', color: T.iconDim, fontSize: 11, cursor: 'pointer', padding: '10px 16px', fontFamily: "'Noto Sans Arabic', sans-serif" }}>پاشگەز</button>
                </div>
              </div>
            )}
          </div>
        ...
        <div style={{ background: T.card, margin: '0 12px', borderRadius: 10, padding: '0 14px', border: `2px solid ${T.text}`, boxShadow: `3px 3px 0 ${T.text}` }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', padding: '13px 0' }}>
            ...
            <span style={{ flex: 1, fontSize: 14, color: T.textMid }}>بارودۆخ</span>
