      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '0 20px' }}>
        ...
        <div style={{ background: '#1a1c22', borderRadius: 16, overflow: 'hidden', marginBottom: 16 }}>
          ...
          <div
            ...
            style={{ padding: '14px 18px', borderBottom: '1px solid rgba(255,255,255,0.06)', cursor: 'pointer' }}
          >
            {editingName ? (
              <div onClick={e => e.stopPropagation()}>
                <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8 }}>
                  <input
                    ...
                    autoFocus
                    style={{ flex: 1, background: '#1f2128', border: '1px solid #333', borderRadius: 10, padding: '10px 12px', fontSize: 13, outline: 'none', direction: 'rtl', color: '#aaa' }}
                  />
              ...
              <div onClick={e => e.stopPropagation()}>
                <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 8 }}>
                  <input
                    ...
                    type="tel"
                    autoFocus
                    style={{ flex: 1, background: '#1f2128', border: '1px solid #333', borderRadius: 10, padding: '10px 12px', fontSize: 13, outline: 'none', color: '#aaa' }}
                  />
